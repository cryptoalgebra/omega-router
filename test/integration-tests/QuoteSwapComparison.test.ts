...
describe('Integral Quote vs Swap (Base):', () => {
  ...
  describe('Boosted Pools Quote vs Swap', () => {
    ...
    it('Boosted: ExactIn: wrap -> swap', async () => {
      ...
      swapPlanner.addCommand(CommandType.INTEGRAL_SWAP_EXACT_IN, [MSG_SENDER, CONTRACT_BALANCE, 0, path, SOURCE_ROUTER])
    ...
    it('Boosted: ExactIn: unwrap -> swap', async () => {
      ...
      swapPlanner.addCommand(CommandType.ERC4626_UNWRAP, [wUSDCContract.address, ADDRESS_THIS, amountInWrappedUSDC, 0])
    ...
    it('Boosted: Multihop: wrap -> swap -> swap -> swap -> unwrap', async () => {
      ...
      swapPlanner.addCommand(CommandType.ERC4626_UNWRAP, [wWETHContract.address, ADDRESS_THIS, CONTRACT_BALANCE, 0])
    ...
    it('Boosted: ExactIn: Split routing: wrap -> swap through two different paths', async () => {
      ...
      swapPlanner1.addCommand(CommandType.ERC4626_UNWRAP, [wWETHContract.address, MSG_SENDER, CONTRACT_BALANCE, 0])
